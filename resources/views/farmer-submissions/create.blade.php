<?php 
// resources/views/farmer-submissions/create.blade.php 
    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4 class="fw-bold">Tambah Pengajuan Data Petani</h4>
                <h6>Form Pengajuan Petani Desa</h6>
            </div>
            <div class="page-btn">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('farmer-submissions.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="farmer_name" class="form-control @error('farmer_name') is-invalid @enderror" 
                                       value="{{ old('farmer_name') }}" required>
                                @error('farmer_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="land_area" class="form-control" value="{{ old('land_area') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Lokasi Lahan (Desa/Kecamatan)</label>
                                <input type="text" name="land_location" class="form-control" value="{{ old('land_location') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="land_status" class="form-select">
                                    ...
                                    <option value="milik" {{ old('land_status') == 'milik' ? 'selected' : '' }}>Milik Sendiri</option>
                                    <option value="sewa" {{ old('land_status') == 'sewa' ? 'selected' : '' }}>Sewa</option>
                                    <option value="garap" {{ old('land_status') == 'garap' ? 'selected' : '' }}>Penggarap</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="main_commodity" class="form-control" 
                                       value="{{ old('main_commodity') }}" placeholder="Padi, Jagung, Kedelai, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary">Ajukan Data Petani</button>
                    </div>
                </form>
            </div>
        </div>
