        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4 class="fw-bold" style="color: #ff9933;">Data Pengajuan Menunggu Validasi</h4>
                    <h6>Pengajuan data petani yang belum diproses</h6>
                </div>
            </div>
                    ...
                    <div class="card" style="background: #ff9933;">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-info text-white">
                                    <h3>{{ $stats['recent'] }}</h3>
                                    <h6>Pengajuan 7 Hari Terakhir</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-header" style="background: #ff9933; border-color: #ff9933;">
                    <h5 class="fw-bold mb-0 text-white">Daftar Pengajuan Menunggu Validasi</h5>
                </div>
                            ...
                            <tbody>
                                @foreach ($submissions as $submission)
                                    <tr>
                                        ...
                                        <td>{{ $submission->land_area ? $submission->land_area . ' Ha' : '-' }}</td>
